...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <aside className="dashboard-sidebar hidden lg:flex fixed left-0 top-0 bottom-0 w-64 bg-[#0a0a0a]/50 backdrop-blur-md overflow-y-auto z-50 border-r border-[#1b1b1b]">
